...
using MicroService.AuthenticationCenter.Constants;

namespace MicroService.AuthenticationCenter.Validator
{
    public class ApiOpenGrantValidator : IExtensionGrantValidator
    {
